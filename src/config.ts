...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    title: 'MoonWX',
    // site subtitle
    subtitle: 'Today only matters if we can remember it tomorrow.',
    // site description
    description: 'MoonWX\'s blog',
    // use i18n title/subtitle/description from src/i18n/ui.ts instead of static ones above
    i18nTitle: true, // true, false
    // author name
    author: 'MoonWX',
    // site url
    url: 'https://blog.moonwx.net',
    // base path
